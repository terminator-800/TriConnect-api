...
export const applicationAcceptedTemplate = ({
  ...
  date,
  jobDetailsUrl
}: ApplicationAcceptedTemplateProps): string => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:10px; overflow:hidden;">
          <tr>
            <td style="background:#28a745; padding:30px 20px; text-align:center;">
          ...
          <tr>
            <td style="padding:30px; color:#333333; font-size:16px; line-height:1.6;">
              ...
              <div style="border-left:4px solid #28a745; padding-left:15px; margin:25px 0;">
