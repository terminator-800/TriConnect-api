...
export const approveAnyJobPost = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const result = await approvePost(connection, mapping.table, mapping.pk, id);
    ...
    logger.error("Error approving job post", { error });
