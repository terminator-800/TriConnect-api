...
import { rejectFindAgency } from '../controllers/userController/reject-application/reject-direct-find-agency.js';
...
router.patch('/manpower-provider/applications/:application_id/reject', authenticate, rejectApplication);
router.patch('/manpower-provider/applications/reject', authenticate, rejectFindAgency);
router.patch('/manpower-provider/notification/:notification_id/seen', authenticate, markNotificationSeen);
