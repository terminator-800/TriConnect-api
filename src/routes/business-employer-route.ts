...
import { sendFinalAgreement } from '../controllers/userController/final-agreement/send-final-agreement.js';
...
router.post('/business-employer/final-agreement', authenticate, sendFinalAgreement);
